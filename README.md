...
4. **Profiles**:
   ...
   - Profiles are stored in `%AppData%\RimModManager\profiles`
...
Configuration is stored in `%AppData%\RimModManager`:
...
- **Graphics**: Native GPU acceleration via DirectX/OpenGL
